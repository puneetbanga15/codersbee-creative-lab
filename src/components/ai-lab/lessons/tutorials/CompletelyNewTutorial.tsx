...
export const CompletelyNewTutorial = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [showBuzzy, setShowBuzzy] = useState(true);
  
  // Simple content for each slide
  const slideContent = [
    {
      ...
      content: () => (
        <div className="space-y-4">
          <p className="text-center text-lg">
            AI Friends are digital buddies that can chat with you!
          </p>
      ...
      buzzyState: "teaching",
      buzzyMessage: "Hi there! I'm Buzzy, your AI friend! Let me teach you about AI Friends!"
    },
    {
        ...
        <div className="space-y-4">
          <div className="bg-purple-50 p-4 rounded-lg">
            <p className="text-center">
              AI Friends process your messages and create thoughtful responses.
            </p>
          </div>
          <div className="flex items-center bg-purple-50 p-3 rounded-lg mb-2">
            ...
            <p className="text-sm">They recognize patterns in your messages</p>
          </div>
          <div className="flex items-center bg-purple-50 p-3 rounded-lg mb-2">
            <div className="bg-purple-200 rounded-full w-8 h-8 flex items-center justify-center mr-3 flex-shrink-0">
          ...
          <div className="flex items-center bg-purple-50 p-3 rounded-lg">
            ...
            <p className="text-sm">They seem real, but they're just code!</p>
          </div>
        </div>
      ),
      buzzyState: "thinking",
      buzzyMessage: "When you talk to me, I process your words and create a response based on patterns!"
    },
    {
      ...
      buzzyState: "excited",
      buzzyMessage: "Training an AI Friend is like teaching a pet tricks! Show examples and we learn to copy!"
    },
    {
      ...
      buzzyMessage: "AI Friends can have different personalities! Which do you like best?"
    },
    {
      ...
      buzzyState: "default",
      buzzyMessage: "Ready to create your AI Friend? Let's get started!"
    }
  ];
  ...
  // The single source of Buzzy in this component
  const renderBuzzy = () => {
    if (!showBuzzy) return null;
    
    return (
      <div className="mb-6 flex items-start gap-4">
        {/* This is the ONLY Buzzy in the entire component */}
        <div className="flex-shrink-0" id="single-buzzy-container">
          <BuzzyAnimation 
            state={slideContent[currentSlide].buzzyState as any} 
            size="md" 
          />
        </div>
        <BuzzySpeechBubble 
          message={slideContent[currentSlide].buzzyMessage}
          state={slideContent[currentSlide].buzzyState as any}
    ...
    <div className="space-y-6">
      <Card className="overflow-hidden">
        <div className="bg-gradient-to-r from-purple-100 to-indigo-100 p-4">
          ...
          <p className="text-sm text-purple-700">Tutorial {currentSlide + 1} of {slideContent.length}</p>
        </div>
        
        <CardContent className="p-6">
          <h3 className="text-lg font-semibold mb-4">{slideContent[currentSlide].title}</h3>
          
          {/* Buzzy section - completely isolated */}
          {renderBuzzy()}
          
          {/* Content section - completely isolated */}
