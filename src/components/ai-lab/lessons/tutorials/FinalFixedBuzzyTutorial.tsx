...
export const FinalFixedBuzzyTutorial = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [showBuzzy, setShowBuzzy] = useState(true);
  const mainRef = useRef<HTMLDivElement>(null);
  
  // Simple slides without any embedded Buzzy images
  const slides = [
    {
      title: "What is an AI Friend?",
      content: (
        <div className="space-y-4" data-slide="what-is-ai-friend">
          {/* NO IMAGES HERE */}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4" data-slide="how-ai-friends-work">
          <div className="p-5 bg-purple-50 rounded-lg mb-3">
            <div className="w-20 h-20 mx-auto bg-purple-200 rounded-full flex items-center justify-center mb-3">
      ...
      buzzyMessage: "When you talk to me, I process your words and create a response!",
      buzzyState: "thinking"
    },
    {
      title: "Training Your AI Friend",
      content: (
        <div className="space-y-4 mt-2" data-slide="training-your-ai-friend">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4" data-slide="different-ai-personalities">
      ...
      buzzyMessage: "AI Friends can have different personalities! Which one do you like best?",
      buzzyState: "encouraging"
    },
    {
      title: "Let's Get Started!",
      content: (
        <div className="flex flex-col items-center justify-center h-full space-y-6" data-slide="lets-get-started">
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      console.log('FinalFixedBuzzyTutorial - Searching for duplicate Buzzy images...');
      
      // This will help find ALL Buzzy images in the DOM
      ...
      allImages.forEach((img, i) => {
        ...
        if (src.toLowerCase().includes('buzzy') || alt.toLowerCase().includes('buzzy')) {
          ...
          // Add a visible highlight to make it obvious
          imgEl.style.border = '3px solid red';
          
          // Option to remove the duplicate image entirely
          if (imgEl.parentElement && !imgEl.parentElement.hasAttribute('data-buzzy-keep')) {
            console.log('REMOVING duplicate Buzzy image');
  ...
  // Emit event when on the last slide
  useEffect(() => {
    ...
    if (currentSlide === slides.length - 1) {
      ...
      // If not on the last slide, reset the state
      const event = new CustomEvent('sectionEndReached', { 
    ...
    <div ref={mainRef} className="space-y-6">
      <Card className="overflow-hidden">
        ...
        <CardContent className="p-6">
          ...
          {/* Buzzy section with our fixed component */}
          {showBuzzy && (
