...
export const TierHeader: React.FC<TierHeaderProps> = ({ stage, title }) => (
  <div className="relative mb-6 rounded-xl overflow-hidden shadow-xl border-2 border-teal-300">
    ...
    />
    {/* Overlay */}
    <div className="absolute inset-0 bg-gradient-to-r from-white/75 to-transparent" />
    <div className="absolute inset-0 flex items-end p-6">
      <h2 className="text-2xl md:text-3xl font-extrabold text-sky-900 drop-shadow-sm tracking-wide">
        {title}
      </h2>
    </div>
  </div>
